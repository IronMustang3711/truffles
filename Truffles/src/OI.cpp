...
void OI::initSmartDashboardCommands() {
    ...
    SmartDashboard::PutData("RunIntake: catchOut", new RunIntake(-1));
    ...
    SmartDashboard::PutData("Gear catch: in (undriven)", new GearCatchChill());
    SmartDashboard::PutData("Gear catch: in", new GearCatchIn());
    SmartDashboard::PutData("Gear catch: catchOut", new GearCatchOut());
}
...
DriverJoyStick::DriverJoyStick() : Joystick(0),
    ...
    ballIntakeButton.WhileHeld(new RunIntake(-0.6));
    ropeClimbButton.WhileHeld(new RunWinch(1.0));
    ropeClimbButton.WhenReleased(new RunWinch(0.3));
    //TODO: change robot direction
}


ShooterJoystick::ShooterJoystick() : Joystick(1),
                                     hexapusButton{this, 1},
                                     flywheelToggleButton{this, 2},
                                     unjamHexapusButton{this, 4},
                                     gearCatchToggleButton{this, 3} {
    hexapusButton.WhileHeld(new RunHexapus(0.75));
    flywheelToggleButton.ToggleWhenPressed(new RunShooter());
    RunHexapus *hexapus = new RunHexapus(-0.5);
    hexapus->timeOut(0.25);
    unjamHexapusButton.WhenPressed(hexapus);
    gearCatchToggleButton.WhenPressed(new GearCatchToggle());
}
