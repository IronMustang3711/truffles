...
Shooter::Shooter() : Subsystem("Shooter") {
	...
	hexapusMotor = RobotMap::hexopusController;
...
void Shooter::runShooterMotor(double input) {
	SmartDashboard::PutNumber("Shooter:shooterMotor:input",input);
   ...
   // double sliderValue = (-stick->GetRawAxis(3) + 1) * 0.5;
    // target in [-5227,0];
    double target = -5227.0 * log10(9.0 * input + 1.0);
    SmartDashboard::PutNumber("Shooter:shooterMotor:target",target);
